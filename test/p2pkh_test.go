...
func TestP2PKH(t *testing.T) {
	...
	addr := address.P2PKHAddressFromAddress("n4bkvTyU1dVdzsrhWBqBw8fEMbHjJvtmJR")
	...
	changeAddr := address.P2PKHAddressFromAddress("mytmhndz4UbEMeoSZorXXrLpPfeoFUDzEp")
	...
	changeLowSAddr := address.P2PKHAddressFromAddress("mmYNBho9BWQB2dSniP1NJvnPoj5EVWw89w")
	...
	sk := keypair.NewECPrivateFromWIF("cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9")

	fromAddr := address.P2PKHAddressFromAddress("myPAE9HwPeKHh8FjKwBNBaHnemApo3dw6e")
	...
	sigFromAddr1 := address.P2PKHAddressFromAddress("n4bkvTyU1dVdzsrhWBqBw8fEMbHjJvtmJR")

	sigFromAddr2 := address.P2PKHAddressFromAddress("mmYNBho9BWQB2dSniP1NJvnPoj5EVWw89w")

	sigSk1 := keypair.NewECPrivateFromWIF("cTALNpTpRbbxTCJ2A5Vq88UxT44w1PE2cYqiB3n4hRvzyCev1Wwo")
	sigSk2 := keypair.NewECPrivateFromWIF("cVf3kGh6552jU2rLaKwXTKq5APHPoZqCP4GQzQirWGHFoHQ9rEVt")

	sigToAddr1 := address.P2PKHAddressFromAddress("myPAE9HwPeKHh8FjKwBNBaHnemApo3dw6e")
	...
	sigToAddr2 := address.P2PKHAddressFromAddress("mmYNBho9BWQB2dSniP1NJvnPoj5EVWw89w")
