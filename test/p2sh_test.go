...
func TestP2SH(t *testing.T) {
	fromAddr := address.P2PKHAddressFromAddress("n4bkvTyU1dVdzsrhWBqBw8fEMbHjJvtmJR")
	sk := keypair.NewECPrivateFromWIF("cTALNpTpRbbxTCJ2A5Vq88UxT44w1PE2cYqiB3n4hRvzyCev1Wwo")
	p2pkSk := keypair.NewECPrivateFromWIF("cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9")
	p2pkRedeemScript := scripts.Script{Script: []interface{}{
	...
	//
	skCsvP2pkh := keypair.NewECPrivateFromWIF("cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9")

	seq := scripts.NewSequence(constant.TYPE_RELATIVE_TIMELOCK, 200, true)

	txinSeq := scripts.NewTxInput("f557c623e55f0affc696b742630770df2342c4aac395e0ed470923247bc51b95", 0, seq.ForInputSequence())

	anotherAddr := address.P2PKHAddressFromAddress("n4bkvTyU1dVdzsrhWBqBw8fEMbHjJvtmJR")
	...
	t.Run("test3", func(t *testing.T) {
		redeemScript := scripts.NewScript(seq.ForScript(), "OP_CHECKSEQUENCEVERIFY", "OP_DROP",
